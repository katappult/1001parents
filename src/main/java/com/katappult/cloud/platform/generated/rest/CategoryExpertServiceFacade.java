...
@RestController
@RequestMapping("/katappult/cloud/app/v1/secured/api/categoryexpert")
public class CategoryExpertServiceFacade {
  ...
  public Serializable create(@RequestBody String request) {
    ...
    uiAttributes.from(request, CategoryExpert.class);
  ...
  public Serializable details(@RequestParam(name = "entityId") final RestObjectFullId entityId,
    ...
    IOperationResult result = new SingleResult();
    CategoryExpert entity = (CategoryExpert) entityId.getPersistable();
