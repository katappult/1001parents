...
@Component("CategoryAgentsFacilitateurBatchWriter")
@Scope("step")
public class CategoryAgentsFacilitateurBatchWriter implements ItemWriter<AbstractLineBean> {

    private static final Logger LOGGER = LoggerFactory.getLogger(CategoryAgentsFacilitateurBatchWriter.class);

    @Autowired
    private KatappultCoreServicesHelper services;

    @Autowired
    private ICategoryAgentsFacilitateurService service;
    ...
    public void write(final List<? extends AbstractLineBean> items) throws Exception {
        ...
        while(entityIterator.hasNext()) {
          ...
          if(command.startsWith("ADD_")){
              ...
              CategoryAgentsFacilitateur entity = (CategoryAgentsFacilitateur) line.getRootEntity();
          ...
          if(command.startsWith("UPDATE_")){
              CategoryAgentsFacilitateur transientEntity = (CategoryAgentsFacilitateur) line.getRootEntity();
