...
@RestController
@RequestMapping("/katappult/cloud/app/v1/secured/api/categoryambassadeur")
public class CategoryAmbassadeurServiceFacade {
  ...
  public Serializable create(@RequestBody String request) {
    ...
    uiAttributes.from(request, CategoryAmbassadeur.class);
  ...
  public Serializable details(@RequestParam(name = "entityId") final RestObjectFullId entityId,
    ...
    IOperationResult result = new SingleResult();
    CategoryAmbassadeur entity = (CategoryAmbassadeur) entityId.getPersistable();
