...
@RestController
@RequestMapping("/katappult/cloud/app/v1/secured/api/ressources")
public class RessourcesServiceFacade {
  ...
  public Serializable create(@RequestBody String request) {
    ...
    uiAttributes.from(request, Ressources.class);
  ...
  public Serializable details(@RequestParam(name = "entityId") final RestObjectFullId entityId,
    ...
    IOperationResult result = new SingleResult();
    Ressources entity = (Ressources) entityId.getPersistable();
