...
@RestController
@RequestMapping("/katappult/cloud/app/v1/secured/api/webinar")
public class WebinarServiceFacade {
  ...
  public Serializable create(@RequestBody String request) {
    ...
    uiAttributes.from(request, Webinar.class);
  ...
  public Serializable details(@RequestParam(name = "entityId") final RestObjectFullId entityId,
    ...
    IOperationResult result = new SingleResult();
    Webinar entity = (Webinar) entityId.getPersistable();
