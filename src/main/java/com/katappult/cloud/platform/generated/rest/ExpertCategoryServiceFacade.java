...
@RestController
@RequestMapping("/katappult/cloud/app/v1/secured/api/expertcategory")
public class ExpertCategoryServiceFacade {
  ...
  public Serializable create(@RequestBody String request) {
    ...
    uiAttributes.from(request, ExpertCategory.class);
