...
@Embeddable
public class WebinarToCategoryLinkId implements Serializable {

    private Long roleAId;
    private Long roleBId;

    public WebinarToCategoryLinkId(){

    }

    public WebinarToCategoryLinkId(Webinar roleA, Category roleB, Container container) {
