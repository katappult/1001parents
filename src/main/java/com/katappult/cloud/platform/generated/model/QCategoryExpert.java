...
/**
 * QCategoryExpert is a Querydsl query type for CategoryExpert
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QCategoryExpert extends EntityPathBase<CategoryExpert> {

    private static final long serialVersionUID = -118259594L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCategoryExpert categoryExpert = new QCategoryExpert("categoryExpert");
...
// ATTRIBUTES
    ...
    public QCategoryExpert(String variable) {
        this(CategoryExpert.class, forVariable(variable), INITS);

        // CONSTRUCTOR
    }

    public QCategoryExpert(Path<? extends CategoryExpert> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QCategoryExpert(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QCategoryExpert(PathMetadata<?> metadata, PathInits inits) {
        this(CategoryExpert.class, metadata, inits);
    }

    public QCategoryExpert(Class<? extends CategoryExpert> type, PathMetadata<?> metadata, PathInits inits) {
