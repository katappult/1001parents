...
@Table(name = "gen_categoryagentsfacilitateur")
@Access(AccessType.PROPERTY)
// ANNOTATIONS
public class CategoryAgentsFacilitateur extends BusinessObject implements Serializable , INumberable{// KNOER
...
// ATTRIBUTES
    ...
    public void updateFrom(Persistable entity) {
        ...
        setNom(((CategoryAgentsFacilitateur)entity).getNom());
        setNom(((CategoryAgentsFacilitateur)entity).getNom());
        setDescription(((CategoryAgentsFacilitateur)entity).getDescription());
        // UPDATE_ATTRIBUTES
    }
    ...
    public Class<?> getDomainClass() {
        return CategoryAgentsFacilitateur.class;
    }


    @Id
    @Override
    @SequenceGenerator(name="gen_categoryagentsfacilitateur_oid_seq", sequenceName="gen_categoryagentsfacilitateur_oid_seq", allocationSize=1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="gen_categoryagentsfacilitateur_oid_seq")
