...
@RestController
@RequestMapping("/katappult/cloud/app/v1/secured/api/demandeagentfacilitateur")
public class DemandeAgentFacilitateurServiceFacade {
  ...
  public Serializable create(@RequestBody String request) {
    ...
    uiAttributes.from(request, DemandeAgentFacilitateur.class);
  ...
  public Serializable details(@RequestParam(name = "entityId") final RestObjectFullId entityId,
    ...
    IOperationResult result = new SingleResult();
    DemandeAgentFacilitateur entity = (DemandeAgentFacilitateur) entityId.getPersistable();
