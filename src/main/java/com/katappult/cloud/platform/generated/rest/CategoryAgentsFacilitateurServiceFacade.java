...
@RestController
@RequestMapping("/katappult/cloud/app/v1/secured/api/categoryagentsfacilitateur")
public class CategoryAgentsFacilitateurServiceFacade {
  ...
  public Serializable create(@RequestBody String request) {
    ...
    uiAttributes.from(request, CategoryAgentsFacilitateur.class);
  ...
  public Serializable details(@RequestParam(name = "entityId") final RestObjectFullId entityId,
    ...
    IOperationResult result = new SingleResult();
    CategoryAgentsFacilitateur entity = (CategoryAgentsFacilitateur) entityId.getPersistable();
