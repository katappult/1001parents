...
@Component("ReplayBatchWriter")
@Scope("step")
public class ReplayBatchWriter implements ItemWriter<AbstractLineBean> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ReplayBatchWriter.class);
    ...
    public void write(final List<? extends AbstractLineBean> items) throws Exception {
        ...
        while(entityIterator.hasNext()) {
          ...
          if(command.startsWith("ADD_")){
              ...
              Replay entity = (Replay) line.getRootEntity();
          ...
          if(command.startsWith("UPDATE_")){
              Replay transientEntity = (Replay) line.getRootEntity();
