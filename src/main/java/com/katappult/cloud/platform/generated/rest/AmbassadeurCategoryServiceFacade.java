...
@RestController
@RequestMapping("/katappult/cloud/app/v1/secured/api/ambassadeurcategory")
public class AmbassadeurCategoryServiceFacade {
  ...
  public Serializable create(@RequestBody String request) {
    ...
    uiAttributes.from(request, AmbassadeurCategory.class);
