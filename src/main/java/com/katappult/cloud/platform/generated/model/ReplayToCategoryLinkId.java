...
@Embeddable
public class ReplayToCategoryLinkId implements Serializable {

    private Long roleAId;
    private Long roleBId;

    public ReplayToCategoryLinkId(){

    }

    public ReplayToCategoryLinkId(Replay roleA, Category roleB, Container container) {
