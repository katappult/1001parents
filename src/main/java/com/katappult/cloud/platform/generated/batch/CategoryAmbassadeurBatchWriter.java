...
@Component("CategoryAmbassadeurBatchWriter")
@Scope("step")
public class CategoryAmbassadeurBatchWriter implements ItemWriter<AbstractLineBean> {

    private static final Logger LOGGER = LoggerFactory.getLogger(CategoryAmbassadeurBatchWriter.class);

    @Autowired
    private KatappultCoreServicesHelper services;

    @Autowired
    private ICategoryAmbassadeurService service;
    ...
    public void write(final List<? extends AbstractLineBean> items) throws Exception {
        ...
        while(entityIterator.hasNext()) {
          ...
          if(command.startsWith("ADD_")){
              ...
              CategoryAmbassadeur entity = (CategoryAmbassadeur) line.getRootEntity();
          ...
          if(command.startsWith("UPDATE_")){
              CategoryAmbassadeur transientEntity = (CategoryAmbassadeur) line.getRootEntity();
