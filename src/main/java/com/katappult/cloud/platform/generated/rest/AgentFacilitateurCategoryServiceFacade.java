...
@RestController
@RequestMapping("/katappult/cloud/app/v1/secured/api/agentfacilitateurcategory")
public class AgentFacilitateurCategoryServiceFacade {
  ...
  public Serializable create(@RequestBody String request) {
    ...
    uiAttributes.from(request, AgentFacilitateurCategory.class);
