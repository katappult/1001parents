...
@Component("AgentFacilitateurCategoryBatchWriter")
@Scope("step")
public class AgentFacilitateurCategoryBatchWriter implements ItemWriter<AbstractLineBean> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AgentFacilitateurCategoryBatchWriter.class);

    @Autowired
    private KatappultCoreServicesHelper services;

    @Autowired
    private IAgentFacilitateurCategoryService service;
    ...
    public void write(final List<? extends AbstractLineBean> items) throws Exception {
        ...
        while(entityIterator.hasNext()) {
          ...
          if(command.startsWith("ADD_")){
              ...
              AgentFacilitateurCategory entity = (AgentFacilitateurCategory) line.getRootEntity();
          ...
          if(command.startsWith("UPDATE_")){
              AgentFacilitateurCategory transientEntity = (AgentFacilitateurCategory) line.getRootEntity();
