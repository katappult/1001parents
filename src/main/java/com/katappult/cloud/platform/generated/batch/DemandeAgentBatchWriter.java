...
@Component("DemandeAgentBatchWriter")
@Scope("step")
public class DemandeAgentBatchWriter implements ItemWriter<AbstractLineBean> {

    private static final Logger LOGGER = LoggerFactory.getLogger(DemandeAgentBatchWriter.class);
    ...
    public void write(final List<? extends AbstractLineBean> items) throws Exception {
        ...
        while(entityIterator.hasNext()) {
          ...
          if(command.startsWith("ADD_")){
              ...
              DemandeAgent entity = (DemandeAgent) line.getRootEntity();
          ...
          if(command.startsWith("UPDATE_")){
              DemandeAgent transientEntity = (DemandeAgent) line.getRootEntity();
