...
@Component("CategoryBatchWriter")
@Scope("step")
public class CategoryBatchWriter implements ItemWriter<AbstractLineBean> {

    private static final Logger LOGGER = LoggerFactory.getLogger(CategoryBatchWriter.class);
    ...
    public void write(final List<? extends AbstractLineBean> items) throws Exception {
        ...
        while(entityIterator.hasNext()) {
          ...
          if(command.startsWith("ADD_")){
              ...
              Category entity = (Category) line.getRootEntity();
          ...
          if(command.startsWith("UPDATE_")){
              Category transientEntity = (Category) line.getRootEntity();
