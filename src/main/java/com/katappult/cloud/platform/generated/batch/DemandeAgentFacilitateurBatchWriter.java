...
@Component("DemandeAgentFacilitateurBatchWriter")
@Scope("step")
public class DemandeAgentFacilitateurBatchWriter implements ItemWriter<AbstractLineBean> {

    private static final Logger LOGGER = LoggerFactory.getLogger(DemandeAgentFacilitateurBatchWriter.class);

    @Autowired
    private KatappultCoreServicesHelper services;

    @Autowired
    private IDemandeAgentFacilitateurService service;
    ...
    public void write(final List<? extends AbstractLineBean> items) throws Exception {
        ...
        while(entityIterator.hasNext()) {
          ...
          if(command.startsWith("ADD_")){
              ...
              DemandeAgentFacilitateur entity = (DemandeAgentFacilitateur) line.getRootEntity();
          ...
          if(command.startsWith("UPDATE_")){
              DemandeAgentFacilitateur transientEntity = (DemandeAgentFacilitateur) line.getRootEntity();
