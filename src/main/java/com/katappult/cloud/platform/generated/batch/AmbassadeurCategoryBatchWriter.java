...
@Component("AmbassadeurCategoryBatchWriter")
@Scope("step")
public class AmbassadeurCategoryBatchWriter implements ItemWriter<AbstractLineBean> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AmbassadeurCategoryBatchWriter.class);

    @Autowired
    private KatappultCoreServicesHelper services;

    @Autowired
    private IAmbassadeurCategoryService service;
    ...
    public void write(final List<? extends AbstractLineBean> items) throws Exception {
        ...
        while(entityIterator.hasNext()) {
          ...
          if(command.startsWith("ADD_")){
              ...
              AmbassadeurCategory entity = (AmbassadeurCategory) line.getRootEntity();
          ...
          if(command.startsWith("UPDATE_")){
              AmbassadeurCategory transientEntity = (AmbassadeurCategory) line.getRootEntity();
