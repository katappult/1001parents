...
@Table(name = "gen_categoryexpert")
@Access(AccessType.PROPERTY)
// ANNOTATIONS
public class CategoryExpert extends BusinessObject implements Serializable , INumberable{// KNOER
...
// ATTRIBUTES
    ...
    public void updateFrom(Persistable entity) {
        ...
        setNom(((CategoryExpert)entity).getNom());
        setNom(((CategoryExpert)entity).getNom());
        setDescription(((CategoryExpert)entity).getDescription());
        // UPDATE_ATTRIBUTES
    }
    ...
    public Class<?> getDomainClass() {
        return CategoryExpert.class;
    }


    @Id
    @Override
    @SequenceGenerator(name="gen_categoryexpert_oid_seq", sequenceName="gen_categoryexpert_oid_seq", allocationSize=1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="gen_categoryexpert_oid_seq")
