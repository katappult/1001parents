...
@Component("WebinarBatchWriter")
@Scope("step")
public class WebinarBatchWriter implements ItemWriter<AbstractLineBean> {

    private static final Logger LOGGER = LoggerFactory.getLogger(WebinarBatchWriter.class);
    ...
    public void write(final List<? extends AbstractLineBean> items) throws Exception {
        ...
        while(entityIterator.hasNext()) {
          ...
          if(command.startsWith("ADD_")){
              ...
              Webinar entity = (Webinar) line.getRootEntity();
          ...
          if(command.startsWith("UPDATE_")){
              Webinar transientEntity = (Webinar) line.getRootEntity();
